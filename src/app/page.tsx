      ...
      <div className="mt-6 flex flex-col ">
        <div className="flex items-center justify-between border-b border-zinc-200 pb-5">
          <div className="space-y-1">
            ...
            <span className="text-sm text-zinc-500">
              Update your photo and personal detais here.
            </span>
          </div>
        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Control
                  id="firstName"
                  defaultValue="Hilquias"
                ></Input.Control>
              </Input.Root>

              <Input.Root>
                <Input.Control defaultValue="Ferreira Melo"></Input.Control>
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            {/* Pode ser que depois tenha que ser removido essa <div/> */}
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Prefix>
            ...
            {/* --- Obs: Não o conteúdo dela, somente a <div/> */}
          </div>
